...
public class UserLoginController {
    ...
    private static final String DB_URL = "jdbc:postgresql://trolley.proxy.rlwy.net:52023/railway";
    private static final String DB_USERNAME = "postgres";
    private static final String DB_PASSWORD = "XTLwwNjeEVCKnIrDdenSyBtHLMQqleTO";
